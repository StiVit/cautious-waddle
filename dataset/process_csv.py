...
transactions = transactions.merge(products[['Product Name', 'product_id']], left_on="Product Name", right_on="Product Name", how = "left")
...
transactions['region'] = transactions['region'].apply(lambda x: Region[x.replace(" ", "_")])
transactions['payment_method'] = transactions['payment_method'].apply(lambda x: PaymentMethod[x.replace(" ", "_")])
products['product_category'] = products['product_category'].apply(lambda x: ProductCategory[x.replace(" ", "_")])
